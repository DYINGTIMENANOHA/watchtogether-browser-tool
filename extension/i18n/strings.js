...
const WT_STRINGS = {
  en: {
    ...
    banner_room_timeout_text: 'The room timed out and was dissolved.',
    ...
    hard_rejoin_btn: 'Fully Reconnect',
    hard_rejoin_working: 'Reconnecting from scratch...',
    hard_rejoin_done: 'Reconnected with a fresh connection.',
    hard_rejoin_failed: 'Full reconnect failed. You have been completely disconnected.',
  ...
  zh: {
    ...
    banner_room_timeout_text: '房间已超时并解散。',
    ...
    hard_rejoin_btn: '完全退出并重进',
    hard_rejoin_working: '正在完全退出并重新接入...',
    hard_rejoin_done: '已通过全新连接重新接入房间。',
    hard_rejoin_failed: '完全重连失败，当前已彻底退出房间。',
  ...
  ja: {
    ...
    banner_room_timeout_text: 'ルームはタイムアウトして解散しました。',
    ...
    hard_rejoin_btn: '完全に退出して再参加',
    hard_rejoin_working: '新しい接続で再参加しています...',
    hard_rejoin_done: '新しい接続でルームに再参加しました。',
    hard_rejoin_failed: '完全再接続に失敗しました。現在はルームから完全に退出しています。',
